	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text">DATA KASUS SISWA</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a href="?page=data-kasus_siswa" class="nav-link">
								<i class="nav-icon far fa fa-users"></i>
								<p>
									Data Kasus Siswa
								</p>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Siswa
				...
				//Kasus Siswa
				case 'data-kasus_siswa':
					include "admin/kasussiswa/data_kasussiswa.php";
					break;
				case 'add-kasus_siswa':
					include "admin/kasussiswa/add_kasussiswa.php";
					break;
				case 'edit-kasus_siswa':
					include "admin/kasussiswa/edit_kasussiswa.php";
					break;
				case 'del-kasus_siswa':
					include "admin/kasussiswa/del_kasussiswa.php";
					break;
